...
class ConnectionHubWidget(QtWidgets.QWidget):
    ...
    def _build_cards_pane(self, cards_view_h: int) -> QtWidgets.QWidget:
        ...
        cards_wrap.setAttribute(QtCore.Qt.WidgetAttribute.WA_StyledBackground, True)
        ...
        scroll.setObjectName("connectionHubCardScroll")
        ...
        viewport.setObjectName("connectionHubCardScrollViewport")
        viewport.setAttribute(QtCore.Qt.WidgetAttribute.WA_StyledBackground, True)
